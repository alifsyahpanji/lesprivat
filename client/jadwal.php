        ...
        <div class="card mt-5 mb-5">
            ...
            <div class="card-body">
                ...
                <form action="savejad.php" method="post">
                    ...
                    switch($data_alert){
                        case "tersedia":
                            ?> <div class="alert alert-warning" role="alert"> <?php echo "Segera pilih jadwal yang tersedia sebelum jadwalnya kosong dipesan murid lain."; ?> </div> <?php
                            break;
                        case "kosong":
                            ?> <div class="alert alert-danger" role="alert"> <?php echo "Sepertinya jadwal les sudah penuh, tidak ada jadwal yang tersedia. silahkan hubungi kami
                            untuk
                            info lebih lanjut 083842368811"; ?> </div> <?php
                            break; 
                    } 
                    ?>
                        ...
                        <select class="form-select" id="jadwal" name="jadwal" required>
                            ...
                            if($count_jadwal){
                                while($row_jadwal = mysqli_fetch_assoc($run_jadwal_query)) {
                                    ?> <option value="<?php echo $row_jadwal["id"] ?>"> <?php echo $row_jadwal["hari"] ?></option> <?php
                                }
                            }
                            ?>
                        </select>
