                ...
                <div class="card-text">
                        ...
                        switch($data_alert){
                            ...
                            ?> <div class="alert alert-success" role="alert"> <?php
                                echo "Terimakasih sudah memilih jadwal les privat, silahkan cek di beranda untuk melihat jadwalnya. untuk info lebih lanjut, akan kami kabari lagi."; ?> </div> <?php
                                break;
                            case "gagalSimpan":
                                ...
                                break; 
                            case "adaJadwal":
                                ?> <div class="alert alert alert-warning" role="alert"> <?php
